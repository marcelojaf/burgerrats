...
extension GetItInjectableX on _i174.GetIt {
  ...
  Future<_i174.GetIt> init({
    ...
    gh.lazySingleton<_i688.LocalePreferencesService>(
    ...
    gh.lazySingleton<_i384.StreakRepository>(
      () => _i349.StreakRepositoryImpl(gh<_i974.FirebaseFirestore>()),
    );
    gh.lazySingleton<_i12.PhotoCaptureService>(
      () => _i12.PhotoCaptureService(gh<_i165.PermissionService>()),
    );
    gh.lazySingleton<_i606.ActivityFeedRepository>(
      () => _i156.ActivityFeedRepositoryImpl(
        gh<_i974.FirebaseFirestore>(),
    ...
    gh.lazySingleton<_i873.StreakTrackerService>(
      () => _i873.StreakTrackerService(
        gh<_i384.StreakRepository>(),
